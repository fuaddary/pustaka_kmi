...
<head>
  ...
  <title>Pustaka KMI - kmi-its.com</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <a href="https://kmi-its.com/" target="_blank">Pustaka KMI ITS</a> </span>
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> {{date('Y')}}
          </div>
        </footer>
        <!-- partial -->
      </div>
